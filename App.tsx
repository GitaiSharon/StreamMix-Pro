...
function App() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-50 font-sans selection:bg-indigo-500/30 flex flex-col relative overflow-hidden">
      ...
      {/* --- Preview & Save Modal --- */}
      {previewBlob && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-zinc-950/80 backdrop-blur-md animate-in fade-in duration-300 p-4">
             <div className="bg-zinc-900 border border-white/10 rounded-2xl shadow-2xl w-full max-w-4xl p-6 flex flex-col gap-6 ring-1 ring-white/5">
